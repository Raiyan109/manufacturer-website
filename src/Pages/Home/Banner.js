        ...
        <section className="text-black body-font">
            <div className="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center">
                <div className="lg:flex-grow flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <p className="mb-8 leading-relaxed opacity-50 ">Delivering Precision-Crafted Submarine Parts with Quality, Durability, and Performance Built to Withstand the Depths of the Ocean - Providing Safe and Reliable Solutions for Your Submarine Needs. </p>
                    <div className="flex justify-center">
                        <Link to='#part'>
                            <button className="inline-flex text-primary btn btn-secondary border-0 py-2 px-6 focus:outline-none hover:bg-pink-200 rounded text-lg">Learn More</button>
                        </Link>
