    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
                <div className="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md" style={{ backgroundImage: `url(${`http://localhost:5000/${photo}`})` }}></div>
                ...
                <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
                    ...
                    <div className="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700">
                        ...
                        <div className='tooltip' data-tip="Available Quantity">
                            <span className="font-bold text-gray-800 dark:text-gray-200">{available}</span>
                        </div>
