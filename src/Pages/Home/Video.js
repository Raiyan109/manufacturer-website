            ...
            <section className='text-gray-600 body-font'>
                <div className='container mx-auto flex flex-col px-5 py-24 justify-center items-center'>
                    ...
                    <div className="flex flex-col text-center w-full mb-20">
                        <h2 className="text-xl text-secondary tracking-widest font-medium title-font mb-1">About Leviathan</h2>
                        <h1 className="sm:text-3xl lg:text-6xl font-medium title-font mb-4 text-gray-900">Experience You Can Trust</h1>
