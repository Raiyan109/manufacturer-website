      ...
      xl:px-5 lg:flex-row">
                    <div class="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
                        <div class="w-full bg-cover relative max-w-md lg:max-w-2xl lg:w-7/12">
                            <div class="flex flex-col items-center justify-center w-full h-full relative lg:pr-10">
                                <img src="https://res.cloudinary.com/macxenon/image/upload/v1631570592/Run_-_Health_qcghbu.png" alt='multi-step-background' class="btn-" />
                            </div>
                        </div>
            ...
            relative z-10">
                            ...
                            <li className="step">Receive Product</li>
                                ...
                                <p class="w-full text-4xl font-medium text-center leading-snug font-serif">{formTitles[page]}</p>
